...
/**
 * ICREDITAFFILIATIONCRUDREPOSITORY: Define las operaciones (CRUD) de la Afiliación
 *                                    de Credito de un cliente el cual extiende del Reactive CRUD.
 */
public interface ICreditAffiliationCrudRepository extends ReactiveCrudRepository<CreditAffiliationDao,String> {
}
